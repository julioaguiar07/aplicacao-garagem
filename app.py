...
">
        ...
        <div style="text-align: center;">
            ...
            <div style="display: flex; flex-direction: column; gap: 0.3rem;">
                ...
                <span style="
                    font-size: 0.9rem; 
                    color: #a0a0a0;
                ">Desenvolvimento & Soluções Automotivas</span>
                
                <span style="
                    font-size: 0.8rem; 
                    color: #666;
                    margin-top: 0.5rem;
                ">© 2026 - Todos os direitos reservados</span>
            </div>
        </div>
    </div>
    ...
    <div style="
        ...
        color: #666;
    ">
        <span style="cursor: pointer; transition: color 0.3s;" onmouseover="this.style.color='#e88e1b'" onmouseout="this.style.color='#666'">Termos de Uso</span>
        <span style="cursor: pointer; transition: color 0.3s;" onmouseover="this.style.color='#e88e1b'" onmouseout="this.style.color='#666'">Privacidade</span>
        <span style="cursor: pointer; transition: color 0.3s;" onmouseover="this.style.color='#e88e1b'" onmouseout="this.style.color='#666'">Suporte</span>
    </div>
</div>
"""
